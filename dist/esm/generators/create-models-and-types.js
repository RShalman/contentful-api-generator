...
export function createTypesModels(basePath) {
            ...
            fields: fields
                ...
                return {
                    ...
                    [id]: {
                        ...
                        required,
                        linkType,
                        validationTypes: findById(contentTypes, id) !== null
                            ? false
...
export function createTypesTS(basePath) {
    const typesModelPath = `${basePath}/contentTypes.json`;
    ...
    `;
        ...
        const validContent = format(notification +
            imports +
            assetType +
            entryType +
